...
export function CreateAdModal () {
    ...
    useEffect(() => {
      // Acesso a rota e recebo resposta 
      // LISTA DE GAMES
    ...
    async function handleCreateAd(event: FormEvent) {
        ...
        // CRIANDO NOVO ANÚNCIO (Pego dados do formulário e envio para a API)
        // POST -> Parâmetros: ROTA (http://localhost:3333/games/id/ads), DADOS do formulário (JSON)
        try {
